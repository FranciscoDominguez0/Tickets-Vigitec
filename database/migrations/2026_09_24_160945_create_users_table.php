...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('status', ['active', 'inactive', 'banned'])->nullable()->default('active')->index()->comment('Estado del usuario');
            $table->dateTime('created')->nullable()->useCurrent()->index()->comment('Fecha de creación');
